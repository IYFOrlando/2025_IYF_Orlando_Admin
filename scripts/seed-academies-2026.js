...
const ACADEMIES_2026_SPRING = [
  ...
  },
  {
    ...
    hasLevels: true,
    levels: [
      { name: "Korean Alphabet", schedule: "9:00 AM - 10:15 AM", teacher: { name: "Lim", email: "" }, order: 1 },
      { name: "Korean Beginner", schedule: "10:20 AM - 11:35 AM", teacher: { name: "Lim", email: "" }, order: 2 }
    ],
    order: 4,
    enabled: true,

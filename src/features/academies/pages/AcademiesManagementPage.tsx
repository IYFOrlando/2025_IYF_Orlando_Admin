...
export default function AcademiesManagementPage() {
  ...
  const [formData, setFormData] =
    React.useState<AcademyInput>(INITIAL_FORM_STATE);
  ...
  const getAssignedTeacher = (
    teacherData: { id?: string; name?: string; email?: string } | undefined,
  ) => {
    if (!teacherData?.email && !teacherData?.name && !teacherData?.id)
      return undefined;
  ...
  const handleLevelChange = (
    index: number,
    field: keyof AcademyLevel,
    value: string | number | AcademyLevel["teacher"],
  ) => {
          ...
          <Grid item xs={12} sm={6} md={4} lg={3} key={academy.id}>
            ...
            >
              ...
              >
                ...
                <CardContent sx={{ pb: 1 }}>
                  ...
                  <Stack spacing={1.5} mt={2}>
                    {/* Teacher */}
                    {(() => {
                      const assignedTeacher = getAssignedTeacher(
                        academy.teacher,
                      );
                      return (
                        <Stack
                    ...
                    <Stack direction="row" spacing={1.5} alignItems="center">
                      ...
                      >
                        {academy.hasLevels
                          ? `${academy.levels?.length || 0} Levels`
                          : academy.schedule || "TBD"}
                      </Typography>
                    </Stack>
                  </Stack>
                </CardContent>
              ...
              <CardActions sx={{ justifyContent: "flex-end", px: 2, py: 1 }}>
                <IconButton
                  size="small"
                  onClick={(e) => handleDeleteClick(e, academy.id)}
                  color="error"
        ...
        <DialogContent sx={{ pt: 3 }}>
          ...
          <Stack spacing={3} mt={1}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setFormData({ ...formData, catchPhrase: e.target.value })
              }
            ...
            <TextField
              ...
              onChange={(e) =>
                setFormData({ ...formData, desc1: e.target.value })
              }
            />
            <TextField
              label="Description 2"
              ...
              onChange={(e) =>
                setFormData({ ...formData, desc2: e.target.value })
              }
            />
            <TextField
              label="Description 3"
            ...
            <TeacherSelector
              ...
              onTeacherChange={(newTeacher) =>
                setFormData({ ...formData, teacher: newTeacher })
              }
            />
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, hasLevels: e.target.checked })
                    }
                  />
                }
                label="Has Levels"
                    ...
                    >
                      ...
                      >
                        ...
                        <TextField
                          ...
                          onChange={(e) =>
                            handleLevelChange(index, "schedule", e.target.value)
                          }
                          sx={{ flex: 1 }}
                        />
                        <TextField
                      ...
                      <TeacherSelector
                        ...
                        onTeacherChange={(newTeacher) =>
                          handleLevelChange(index, "teacher", newTeacher)
                        }
                      />
                    </Box>
                  ))}

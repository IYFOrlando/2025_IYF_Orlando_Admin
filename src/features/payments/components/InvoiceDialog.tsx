...
export default function InvoiceDialog({
  ...
  const { getInstructorByAcademy } = useSupabaseInstructors();
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.instructor) {
      if (
        !formData.instructor.firstName ||
        formData.instructor.firstName.trim() === ""
      ) {
        newErrors.instructorFirstName = "Instructor's first name is required";
      }
      if (
        !formData.instructor.lastName ||
        formData.instructor.lastName.trim() === ""
      ) {
      ...
      if (
        ...
        (!formData.instructor.credentials ||
          formData.instructor.credentials.trim() === "")
      ) {
        newErrors.instructorCredentials =
          "Instructor credentials are required for elective courses";
      }
    }

    // Dates and hours validation
    if (
      formData.instructionDates?.startDate &&
      formData.instructionDates?.endDate
    ) {
      ...
      if (
        !formData.instructionDates.totalHours ||
        formData.instructionDates.totalHours <= 0
      ) {
        newErrors.totalHours =
          "Total hours of instruction must be greater than 0";
      }
    }
    ...
    if (isElectiveCourse) {
      if (!formData.serviceRate || formData.serviceRate <= 0) {
        newErrors.serviceRate =
          "Service rate is required and must be greater than 0 for elective courses";
      }
  ...
  const handleSave = () => {
    ...
    const line: InvoiceLine = {
      ...
      instructor:
        formData.instructor?.firstName && formData.instructor?.lastName
          ? {
      ...
      instructionDates:
        ...
        formData.instructionDates?.endDate
          ...
          : undefined,
      serviceRate:
        formData.serviceRate && formData.serviceRate > 0
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInputChange("level", e.target.value || null)
              }
            />
          </Grid>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructorChange("firstName", e.target.value)
              }
              required
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructorChange("lastName", e.target.value)
              }
              required
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructorChange("credentials", e.target.value)
              }
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructionDatesChange("startDate", e.target.value)
              }
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructionDatesChange("endDate", e.target.value)
              }
              InputLabelProps={{ shrink: true }}
          ...
          <Grid item xs={6}>
            <TextField
              ...
              helperText={
                errors.totalHours ||
                "Total hours of instruction including the year"
              }
              required
            />
          </Grid>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInstructionDatesChange("schedule", e.target.value)
              }

import { Box, Paper, Typography, Button, Stack, Alert, useTheme, Avatar } from '@mui/material'
        ...
        >
          <Stack spacing={4} alignItems="center">
            ...
            <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 280, opacity: 0.8 }}>
              This is a restricted administrative portal. Please sign in with your authorized Google account to continue.
            </Typography>
            ...
            <Typography variant="caption" color="text.secondary" align="center">
              ...
              <a href="mailto:orlando@iyfusa.org" style={{ color: theme.palette.primary.main, fontWeight: 600, textDecoration: 'none' }}>
                orlando@iyfusa.org
              </a>
            </Typography>
